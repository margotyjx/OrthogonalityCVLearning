...
class DiffusionMap(object):
    ...
    def __init__(self, alpha=0, epsilon="MAX_MIN", num_evecs=3, pbc_dims=None,
    ...
    def _construct_diffusion_coords(self, L):
        ...
        evals, evecs = sps.linalg.eigs(L, self.num_evecs + 2, which='LR')
...
class TargetMeasureDiffusionMap(DiffusionMap):
    ...
    """
    def __init__(self, target_measure, epsilon=0.1, num_evecs=3, pbc_dims=None,
                 n_neigh=None, density=None):
